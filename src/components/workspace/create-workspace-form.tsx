...
export default function CreateWorkspaceForm({
   ...
   const { mutate, isPending } = useApiMutation({
      ...
      onSuccessHandler: (data) => {
         ...
         queryClient.resetQueries({ queryKey: [QueryKeys.WORKSPACES] });
         onClose();
         ...
         <div className='h-full px-10 py-10 flex-1'>
           ...
           text-center sm:text-left'
               ...
               <p className='text-muted-foreground text-lg leading-tight'>
                  ...
                  access projects in one location.
               </p>
            </div>
            <Form {...form}>
               <form onSubmit={form.handleSubmit(onSubmit)}>
                     ...
                     <FormField
                        ...
                        render={({ field }) => (
                           <FormItem>
                              ...
                              <FormDescription>
                                 Get your members on board with a few words
                  ...
                  <Button
                     ...
                     type='submit'
                  >
                     {isPending && <Loader className='w-6 h-5 animate-spin' />}
                     Create Workspace
                  </Button>
               </form>
            </Form>
